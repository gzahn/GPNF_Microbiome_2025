...
## Load Data ####
meta <- read_xlsx("./data/metadata/clean_metadata_becca_test.xlsx")
meta
...
fung_F <- "CTTGGTCATTTAGAGGAAGTAA"  # ITS86
fung_R <- "GCATCGATGAAGAACGCAGC"  # ITS4
...
itsxpress_path <- "/home/geoff/miniforge3/envs/itsxpressenv/bin/itsxpress"
